...
- **Included credits:** 10 (enough for one to two experiments)
...
**Example:** A team with 30 credits/month can typically run 3-6 experiments, assuming each consumes ~2-3 credits.
