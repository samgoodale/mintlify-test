...
bool isEnvironmentEnabled = featureFlag.EnvironmentEnabled;

// Retrieve the key of the default variation
string defaultVariationKey = featureFlag.DefaultVariationKey;

// Retrieve all variations of the feature flag
...
```csharp
// Retrieve all variations of the rule
