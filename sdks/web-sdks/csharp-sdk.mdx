...
export const Context = {
    ...
    DataFile: {
        ...
        Ref: "#datafile",
        Params: {
            FeatureFlags: { Name: "FeatureFlags", Type: "IReadOnlyDictionary<string, FeatureFlag>" },
        }
    },
    FeatureFlag: {
        Name: "FeatureFlag",
        ...
        Params: {
            ...
            Variations: { Name: "Variations", Type: "IReadOnlyDictionary<string, Variation>" },
            Rules: { Name: "Rules", Type: "IReadOnlyList<Rule>" },
...
try
{
    var dataFile = kameleoonClient.GetDataFile();
}
catch (Exception e)
{
