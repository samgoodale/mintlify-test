...
kameleoon_client.add_data(visitor_code, ApplicationVersion("1.2"))
```
...
# Retrieve all variations of the feature flag as a dict
...
```python
# Retrieve all variations of the rule as a dict
