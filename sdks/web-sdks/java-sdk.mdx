...
Create a `.properties` configuration file to provide credentials and customize SDK behavior. You can also [download our sample configuration](./assets/client configs/client-java.properties) file.
...
```java
kameleoonClient.addData(visitorCode, new ApplicationVersion("1.2.3"));
```
