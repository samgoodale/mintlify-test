...
You can customize the behavior of the PHP SDK via a configuration file. We provide a sample configuration file named `client-php.json.sample` in the SDK archive. You can also [download a sample configuration](./assets/client%20configs/client-php.json) file. We suggest to install this file to the default path of `/tmp/kameleoon/client-php.json`. The following table shows the available properties that you can set:
...
<ActivatingAFeatureFlag sec="retrieving_a_feature_flag_configuration___cron_job_interval_tracking" c={Context}/>
...
<ActivatingAFeatureFlag sec="tracking_goal_conversions___param___cron_job_interval_tracking" c={Context}/>
...
##### Arguments
<AddData sec="arguments_track" c={Context}/>
