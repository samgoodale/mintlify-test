...
| `networkDomain` / `network_domain` _(optional)_                                       | Custom domain used by SDKs for outgoing requests, often for proxying. Must be a valid domain (e.g., `example.com` or `sub.example.com`). Invalid formats default to Kameleoon's value.                                                                                                                                                                                               | `null`                       |
