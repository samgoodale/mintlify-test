...
You can also [download a sample configuration](./assets/client configs/kameleoon-client.properties) file.
...
<SharedDiv sec="coroutine_warning" c={Context} ui={SdkUi} shared={Shared}/>
...
<Tab title="Java">
```java
kameleoonClient.addData(new ApplicationVersion("1.2.3"));
```
</Tab>
<Tab title="Kotlin">
```kotlin
kameleoonClient.addData(ApplicationVersion("1.2.3"))
```
</Tab>
</Tabs>
