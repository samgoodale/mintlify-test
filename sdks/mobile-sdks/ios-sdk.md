...
To customize the SDK's behavior, create a `kameleoon-client-swift.plist` configuration file in the root directory of your Xcode project. You can also [download a sample configuration](./assets/client%20configs/kameleoon-client-swift.plist) file.
